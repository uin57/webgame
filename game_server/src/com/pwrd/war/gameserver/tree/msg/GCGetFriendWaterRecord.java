 ...
 */
public class GCGetFriendWaterRecord extends GCMessage{
	
	/** 好友信息列表 */
	private com.pwrd.war.gameserver.tree.HumanTreeWaterInfo[] humanTreeWaterInfo;

	public GCGetFriendWaterRecord (){
	}
	...
	public short getType() {
		return MessageType.GC_GET_FRIEND_WATER_RECORD;
	}
	
	@Override
	public String getTypeName() {
		return "GC_GET_FRIEND_WATER_RECORD";
	}

 ...
 */
public class CGXinghunPiliangXilian extends CGMessage{
	...
	public short getType() {
		return MessageType.CG_XINGHUN_PILIANG_XILIAN;
	}
	
	@Override
	public String getTypeName() {
		return "CG_XINGHUN_PILIANG_XILIAN";
	}
	...
	@Override
	public void execute() {
		ItemHandlerFactory.getHandler().handleXinghunPiliangXilian(this.getSession().getPlayer(), this);
	}
}
 ...
 */
public class GCXiulianBeCollectSymbol extends GCMessage{
	...
	public GCXiulianBeCollectSymbol (){
	}
	...
	public short getType() {
		return MessageType.GC_XIULIAN_BE_COLLECT_SYMBOL;
	}
	
	@Override
	public String getTypeName() {
		return "GC_XIULIAN_BE_COLLECT_SYMBOL";
	}

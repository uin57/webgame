...
public class BossField extends PvMField {
	private int oHp;//之前的hp
	
	public BossField(Player player, VisibleMonster monster) {
		//构造进攻方
	...
	public void pvmEndImpl(boolean attWin, long timeCost) {
		...
		Globals.getActivityService().getBossActivity().playerEndAttack(nowHp == 0, attPlayer, visibleMonster, 
				lossHp, nowHp);
	}

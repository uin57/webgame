...
import com.pwrd.war.gm.constants.GMLangConstants;
 ...
 * 
 */
public class GmSysLangGenerator {

	/** 日志 */
	private static final Logger logger = Logger
			.getLogger(GmSysLangGenerator.class);

	/** 类型 */
	private static final String TYPE_INT = "Integer";

	/** 相对路径 */
	private static final String SYS_LANG_PATN = "..\\gm_server\\gm_server\\resource\\i18n\\zh_CN\\gm_lang.xls";
	...
	private static List<Map<String, String>> getSysLangData() {
		...
		try {
			Class<GMLangConstants> clazz = GMLangConstants.class;
...
//					id.setCellValue(Integer.valueOf(dataMap.get("id")));
					...
					id.setCellValue("lang_"+dataMap.get("id"));
					...
					HSSFCell comment = rowValue.createCell(2);
					comment.setCellStyle(cellStyle);
					comment.setCellType(HSSFCell.CELL_TYPE_STRING);
					comment.setCellValue(dataMap.get("content"));
...
//					}
	...
	public static void main(String[] args) throws IllegalArgumentException,
		...
		System.out.println("gm_lang.xls重新生成完毕。");
	}
}

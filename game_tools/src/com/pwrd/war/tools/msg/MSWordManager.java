...
public class MSWordManager {
	...
	public void openDocument(String docPath) {
		String _realPath = new File(docPath).getAbsolutePath();
		closeDocument();
		doc = Dispatch.call(documents, "Open", _realPath).toDispatch();
		selection = Dispatch.get(word, "Selection").toDispatch();
	}
	...
	public int getTableCount() {
		...
		return Dispatch.get(tables, "Count").toInt();
	}
	 ...
	 * @return
	 */
	public int getTableRows(int tableIndex) {
		Dispatch tables = Dispatch.get(doc, "Tables").toDispatch();
		Dispatch table = Dispatch.call(tables, "Item", new Variant(tableIndex))
				.toDispatch();
		Dispatch rows = Dispatch.get(table, "Rows").toDispatch();
		return Dispatch.get(rows, "Count").toInt();
	}
	 ...
	 * @return
	 */
	public int getTableCols(int tableIndex) {
		Dispatch tables = Dispatch.get(doc, "Tables").toDispatch();
		Dispatch table = Dispatch.call(tables, "Item", new Variant(tableIndex))
				.toDispatch();
		Dispatch cols = Dispatch.get(table, "Columns").toDispatch();
		return Dispatch.get(cols, "Count").toInt();
	}
	...
	public void putTxtToCell(int tableIndex, int cellRowIdx, int cellColIdx,
			String txt) {
		putSelectCell(tableIndex, cellRowIdx, cellColIdx);
		putTxt(txt);
	}
	 ...
	 * @param cellColIdx
	 */
	public void putSelectCell(int tableIndex, int cellRowIdx, int cellColIdx) {
		// 所有表格
		Dispatch tables = Dispatch.get(doc, "Tables").toDispatch();
		// 要填充的表格
		Dispatch table = Dispatch.call(tables, "Item", new Variant(tableIndex))
	...
	public void setTableBorderWidth(int w,int tableIndex){
		if(w>13||w<1){
			w = 6;
			tables = Dispatch.call(doc, "Tables").toDispatch();
	...
	public static void main(String args[]) throws Exception {
		...
		msWordManager.createTable(3, 3);
		msWordManager.mergeCell(msWordManager.getTableCount(), 2, 1, 2, 2);
		System.out.println(msWordManager.getTableRows(msWordManager.getTableCount()));
		System.out.println(msWordManager.getTableCols(msWordManager.getTableCount()));
		msWordManager.addCol(msWordManager.getTableCount());
//		msWordManager.mergeCell(msWordManager.getTableCount(), msWordManager.getTableRows(msWordManager.getTableCount()), msWordManager.getTableCols(msWordManager.getTableCount()), msWordManager.getTableRows(msWordManager.getTableCount()), msWordManager.getTableCols(msWordManager.getTableCount())+1);
		msWordManager.moveEnd();

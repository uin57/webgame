...
public class HibernateDBServcieImpl implements DBService {
	private static final Logger logger = LoggerFactory.getLogger("war.db.hibernate");
	 ...
	 */
	public HibernateDBServcieImpl(URL hibernateCfgXmlUrl,
	 ...
	 *            Mapping配置文件(如定义查询的配置,以及单独的mapping文件等),这些资源需要在classpath中可以找到
	 */
	public HibernateDBServcieImpl(IEventListener eventListener,

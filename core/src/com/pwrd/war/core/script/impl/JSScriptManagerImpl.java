package com.pwrd.war.core.script.impl;
...
public class JSScriptManagerImpl implements IScriptEngine {
	...
	public Object runScript(Map<String, Object> binding, String scriptFile, String charset) {
		...
		try {
			...
			throw new RuntimeException(ErrorsUtil.error(com.pwrd.war.common.constants.CommonErrorLogInfo.FILE_IO_FAIL, "Throw Exception",
					scriptFile), e);
		} catch (ScriptException se) {
			throw new RuntimeException(ErrorsUtil.error(com.pwrd.war.common.constants.CommonErrorLogInfo.SCRITP_EXECUTE_FAIL,
